...
function AppBar() {
  ...
  return (
    <>
      <div
        className={`py-1 flex justify-between draggable fixed top-0 left-0 right-0 z-20 border-b-[1px] ${
          darkMode ? 'text-gray-200 border-white' : 'text-gray-800 border-gray-800'
        }`}
      >
